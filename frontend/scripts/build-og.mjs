 ...
 * unfurler renders when an EVSPolls link is shared.
 *
 * There was no such image before. index.html pointed og:image at "/logo.svg",
 * which fails twice over: the URL is relative, and unfurlers resolve nothing,
 * and even resolved it is an SVG, which almost none of them render. Every
 * shared link previewed blank.
 *
...
const work = mkdtempSync(join(tmpdir(), 'evspolls-og-'));
